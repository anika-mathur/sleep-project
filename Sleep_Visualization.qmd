...
library(readxl)
library(ggplot2)
df <- read_excel("es193ds_sleep_data.xlsx") #read in sleep data
...
# Create the bar plot using ggplot2 with facet grid and custom labels
p <- ggplot(df, aes(x = date, y = hours, fill = quality)) +
  geom_bar(stat = "identity", position = "dodge") +
  facet_grid(stress ~ dreams, labeller = custom_labeller) +
  labs(x = "Date", y = "Hours of Sleep", fill = "Quality") +
